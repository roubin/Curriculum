...
\setmarginsrb{1cm}{1.2cm}{1cm}{1.2cm}{0cm}{0cm}{0cm}{0cm}
...
\fancyhead{}
\fancyfoot{}
\rfoot{\footnotesize mise à jour : janvier 2016}
...
\begin{minipage}{4cm}
  ...
  \centering
  \fbox{\href{http://perso.crans.org/roubin}{\includegraphics[width=3cm]{img/id.eps}{}}} \\ \vspace{0.1cm}
